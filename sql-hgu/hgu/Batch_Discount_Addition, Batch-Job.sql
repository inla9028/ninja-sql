...
SELECT a.transaction_number, a.ban_no, a.subscriber_no, a.discount_code,
  ...
  WHERE a.request_id     = 'makl8349 2022-05-31'
...
SELECT a.process_status, COUNT(*) AS "COUNT",
       TO_NUMBER(LTRIM(TO_CHAR((COUNT(*) * 1.010) / 3600, '9999999'))) || ' hours ' ||
       TO_NUMBER(LTRIM(TO_CHAR(MOD((COUNT(*) * 1.010) / 60, 60),   '9999999'))) || ' min' AS "QUEUE"
  FROM ninjadata.batch_discount_addition a
  WHERE a.request_id     = 'makl8349 2022-05-31'

...
/*
** Insert records based on the available socs for the priceplan PW11.
...
SELECT DECODE(s.soc
              --
              -- Done previously in production, apparently not in PT.
              --             
              , 'HPMBNSIP',    'SIP_MBN_TRIGGER'       -- Phonero SIP MBN Type Trigger
              , 'HPSIPA01',    'SIP_ADDITIONAL_NUMBER' -- Phonero SIP Additional Number 
              , 'HPSIPM01',    'SIP_MAIN'              -- Phonero SIP Trunk Main
              --
              -- The new SIP Call Forwarding SOCs
              --
              , 'HPSIPCFNR',   'SIP_CALL_FORWARD_NOT_REACHABLE'     -- SIP Forwarding Not Reachable
              , 'HPSIPCFU',    'SIP_CALL_FORWARD_UNCONDITIONAL' -- SIP Forwarding Unconditional
              --
              -- Done...
              --
              , s.soc) AS "SP_CODE"
 ...
 WHERE sts.subscription_type_id  = 'PW11' || 'REG1'

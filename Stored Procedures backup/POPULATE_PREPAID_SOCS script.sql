DROP PACKAGE POPULATE_PREPAID_SOCS;

CREATE OR REPLACE PACKAGE populate_prepaid_socs AS
...
/
DROP PACKAGE BODY POPULATE_PREPAID_SOCS;

CREATE OR REPLACE PACKAGE BODY populate_prepaid_socs
AS
    PROCEDURE add_wdfpre_service
    IS
        CURSOR c1

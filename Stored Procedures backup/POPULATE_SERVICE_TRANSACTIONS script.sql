DROP PACKAGE POPULATE_SERVICE_TRANSACTIONS;

CREATE OR REPLACE PACKAGE populate_service_transactions
AS
...
/
DROP PACKAGE BODY POPULATE_SERVICE_TRANSACTIONS;

CREATE OR REPLACE PACKAGE BODY populate_service_transactions
AS
